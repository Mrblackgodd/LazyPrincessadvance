...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '2034654684').split()]
LAZY_RENAMERS = (lazy_renamers + ADMINS) if lazy_renamers else []
REQ_CHANNEL = int(environ.get('REQ_CHANNEL'))

#ai
AI = is_enabled((environ.get("AI","True")), False)
OPENAI_API = environ.get("OPENAI_API","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")
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001748572062")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
# Requested Content template variables ---
ADMIN_USRNM = environ.get('ADMIN_USRNM','EMPERORns') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','gfdgfdhdttrhh') # WITHOUT @
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+nKz9rQJ893BlMGRl") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/gfdgfdhdttrhh"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/gfdgfdhdttrhh"
